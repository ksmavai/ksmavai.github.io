...
export default function Sidebar({
  ...
  // const [groupedNotes, setGroupedNotes] = useState<any>({}); // Replaced with useMemo
  ...
  // Removed SessionNotesContext usage
  const notes = useMemo(
    () => [...publicNotes],
    [publicNotes]
  );
  // Replaced sessionId with "static" or null
  ...
  }, [notes]); // Removed sessionId dep

  // Calculate grouped notes immediately (enables SSR)
